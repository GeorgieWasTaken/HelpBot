...
from keyboards import answer_on_menu, menu, stop_the_bot, kouch_menu, answer_on_kouch_menu, question_for_all, \
    question_for_one
...
async def next_menu(call: CallbackQuery):
    ...
    if callback_data == 'km:1':
        ...
        for i in range(count):
            ...
            print(telegram_id)
            await bot.send_message(chat_id=telegram_id,text="Здарова")
